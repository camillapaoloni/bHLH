...
p1 <- ggplot(highlight_df, aes(
  ...
  labs(x = "Relative Position of the bHLH domain", y = "Gene Symbol", fill = "Class") +
  class_colors +
  theme_classic() +
  theme(
...
print(final_plot)
# Save SVG
ggsave(file.path(output_dir, "bHLH_human_position.svg"), plot = final_plot, width = 20, height = 12, units = "in")
