...
ggsave(file.path(output_dir, "bHLH_human_transcript_classA_A3.svg"), plot =plots_transcripts_human$A, width = 11.7, height = 16.5, units = "in")
plots_transcripts_human$A
# Save plot for Class B
ggsave(file.path(output_dir, "bHLH_human_transcript_classB_A3.svg"), plot = plots_transcripts_human$B, width = 11.7, height = 16.5, units = "in")
plots_transcripts_human$B
# Save plot for Class C
ggsave(file.path(output_dir, "bHLH_human_transcript_classC_A3.svg"), plot = plots_transcripts_human$C, width = 11.7, height = 16.5, units = "in")
plots_transcripts_human$C
# Save plot for Class D
ggsave(file.path(output_dir, "bHLH_human_transcript_classD_A3.svg"), plot = plots_transcripts_human$D, width = 11.7, height = 16.5, units = "in")
plots_transcripts_human$D
# Save plot for Class E
ggsave(file.path(output_dir, "bHLH_human_transcript_classE_A3.svg"), plot = plots_transcripts_human$E, width = 11.7, height = 16.5, units = "in")
plots_transcripts_human$E
# Save plot for Class NC (Not Classified)
ggsave(file.path(output_dir, "bHLH_human_transcript_classNC_A3.svg"), plot = plots_transcripts_human$NC, width = 11.7, height = 16.5, units = "in")
